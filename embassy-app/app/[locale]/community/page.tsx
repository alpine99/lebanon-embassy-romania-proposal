...
import { CommunityRegistrationForm } from "@/components/community/CommunityRegistrationForm";
...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  ...
  return buildPageMetadata({
    locale,
    path: "/community",
    title: dict.centres.community.heading,
    description: dict.centres.community.intro,
  });
}
...
export default function CommunityPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="mx-auto max-w-content px-5 py-12 sm:py-14">
      ...
      <CommunityRegistrationForm locale={locale} dict={dict} />
    </div>
  );
}
